...
# Para SQLite (MVP). Preparado para PostgreSQL usando variables de entorno
# Ejemplo futuro: DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://user:password@localhost/dbname")

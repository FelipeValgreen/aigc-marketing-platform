...
from app.models.models import Client, BrandGuidelines, Project
from app.schemas.schemas import ClientCreate, ClientOut, ProjectCreate
from app.services.scraper_service import scrape_website_text
from app.services.llm_service import analyze_brand_voice, generate_video_script, generate_carousel_and_copy
from app.schemas.schemas import ScriptRequest, GenerateAudioRequest
import asyncio
import time
...
async def approve_and_render_project(project_id: int, db: Session = Depends(get_db)):
    ...
    try:
        from app.services.audio_service import generate_voiceover
        from app.services.video_service import assemble_ugc_video
        from app.services.stock_video_service import download_background_video
